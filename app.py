...
st.set_page_config(page_title="InfraTrack v5.4", page_icon="🚆", layout="wide") # Version updated

# --- CSS ---
# ... (CSS Identico a v5.3 - omesso per brevità) ...
st.markdown("""
<style>
    /* ... */
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v5.4") # Version updated
...
if uploaded_file is not None:
    if not st.session_state.file_processed_success:
        with st.spinner('Caricamento e analisi completa del file in corso...'):
            try:
                # ... (Logica parsing e estrazione dati generali/date progetto/minuti_giorno identica a v5.3) ...
                ...
                def format_duration_from_xml(duration_str):
                     # ... (funzione durata identica a v5.3) ...
                ...
                for task in all_tasks:
                    # ... (Logica estrazione dati attività identica a v5.3) ...
                    ...
                    # Logica TUP/TUF (identica a v5.3)
                ...
                # Salvataggio dati TUP/TUF e All Tasks (Identico a v5.3)
    ...
    if st.session_state.file_processed_success:
        # --- Sezione 2: Analisi Preliminare (Identica a v5.3) ---
        st.markdown("---")
        st.markdown("#### 2. Analisi Preliminare")
        st.markdown("##### 📄 Informazioni Generali dell'Appalto")
        # ... (Visualizzazione dati generali e TUP/TUF + download identica a v5.3) ...
        ...
        # --- Sezione 3: Analisi Avanzata (Identica a v5.3) ---
        ...
        if all_tasks_df is not None and not all_tasks_df.empty:
            try:
                # ... (Logica filtro data e analisi criticità identica a v5.3) ...
