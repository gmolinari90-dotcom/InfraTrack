# --- v10.2 (Correzione definitiva IndentationError) ---
...
st.set_page_config(page_title="InfraTrack v10.2", page_icon="🚆", layout="wide") # Version updated

# --- CSS ---
st.markdown("""
<style>
    /* ... (CSS identico a v10.1) ... */
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v10.2") # Version updated
            ...
            try:
                ...
                if not baseline_cost_df.empty:
                    ...
                    if not filtered_cost.empty:
                        ...
                        fig_sil = px.line(monthly_cost, x='Mese', y='Costo Cumulato (€)', title='Curva S - Costo Cumulato Baseline', markers=True)
