...
import re
import isodate
from io import BytesIO # Import BytesIO for handling file in memory

# --- CONFIGURAZIONE DELLA PAGINA ---
st.set_page_config(page_title="InfraTrack v1.1", page_icon="🚆", layout="wide") # Version updated
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v1.1") # Version updated
    ...
    with st.spinner('Caricamento e analisi del file in corso...'):
        try:
            ...
            if final_milestones_data:
                ...
                # --- AGGIUNTA BOTTONE DOWNLOAD EXCEL ---
                output = BytesIO()
                # Scriviamo il DataFrame in un file Excel in memoria
