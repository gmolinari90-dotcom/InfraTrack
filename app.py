...
st.set_page_config(page_title="InfraTrack v3.10", page_icon="🚆", layout="wide") # Version updated
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v3.10") # Version updated
...
if uploaded_file is not None:
    ...
    if not st.session_state.file_processed_success:
        with st.spinner('Caricamento e analisi completa del file in corso...'):
            try:
                # ... (Logica parsing e estrazione dati identica a v3.9) ...
                ...
                for task in all_tasks:
                    ...
                    if total_slack_str:
                         try: slack_duration = isodate.parse_duration('PT' + total_slack_str + 'S'); total_slack_days = round(slack_duration.total_seconds() / (8 * 3600))
                         except ValueError:
                    ...
                    if st.button("📈 Analizza Criticità", key="analyze_critical_path"):
                        ...
                        if not critical_subcritical_tasks.empty:
                            ...
                            display_critical_df = critical_subcritical_tasks[[
                                ...
                                "Start": "Inizio",
                                "Finish": "Fine",
                                "TotalSlackDays": "Slack (g)" # Mapping completo
                            })
                            # --- FINE CORREZIONE ---
