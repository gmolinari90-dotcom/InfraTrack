# --- v8.2 (Base Stabile + Selezione Date + Fix SyntaxError Definitivo) ---
...
st.set_page_config(page_title="InfraTrack v8.2", page_icon="🚆", layout="wide") # Version updated

# --- CSS ---
# ... (CSS Identico a v8.1 - omesso per brevità) ...
st.markdown("""
<style>
    /* ... */
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v8.2") # Version updated
...
if uploaded_file is not None:
    if not st.session_state.file_processed_success:
        with st.spinner('Caricamento e analisi completa del file in corso...'):
            try:
                # ... (Logica parsing e estrazione dati generali/date progetto/minuti_giorno identica a v8.1) ...
                ...
                def format_duration_from_xml(duration_str):
                     # ... (funzione durata identica a v8.1) ...
                ...
                for task in all_tasks:
                    # ... (Logica estrazione dati attività identica a v8.1) ...
                    ...
                    # Logica TUP/TUF (identica a v8.1)
                ...
                # Salvataggio dati TUP/TUF e All Tasks (Identico a v8.1)
