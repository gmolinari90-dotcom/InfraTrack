...
st.set_page_config(page_title="InfraTrack v4.6", page_icon="🚆", layout="wide") # Version updated
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v4.6") # Version updated
...
if uploaded_file is not None:
    if not st.session_state.file_processed_success:
        with st.spinner('Caricamento e analisi completa del file in corso...'):
            try:
                # ... (Logica parsing e estrazione dati generali/date progetto/minuti_giorno identica a v4.5) ...
                ...
                def format_duration_from_xml(duration_str):
                     # ... (funzione durata identica a v4.5) ...
                ...
                for task in all_tasks:
                    # ... (Logica estrazione dati attività identica a v4.5, incluso calcolo slack) ...
                    ...
                    # Logica TUP/TUF (identica a v4.5)
                ...
                # --- CORREZIONE: Usa .get() per costruire final_milestones_data (come v4.4) ---
    ...
    if st.session_state.file_processed_success:
        # --- Sezione 2: Analisi Preliminare (Identica a v4.5) ---
        st.markdown("---")
        ...
        # --- Sezione 3: Analisi Avanzata (Identica a v4.5) ---
        ...
        if all_tasks_df is not None and not all_tasks_df.empty:
            try:
                # ... (Logica filtro data e analisi criticità identica a v4.5) ...
