# --- v8.1 (Base Stabile + Selezione Date + Fix KeyError) ---
...
st.set_page_config(page_title="InfraTrack v8.1", page_icon="🚆", layout="wide") # Version updated

# --- CSS ---
# ... (CSS Identico a v8.0 - omesso per brevità) ...
st.markdown("""
<style>
    /* ... */
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v8.1") # Version updated
...
if uploaded_file is not None:
    if not st.session_state.file_processed_success:
        with st.spinner('Caricamento e analisi completa del file in corso...'):
            try:
                # --- Logica parsing e estrazione dati ---
                ...
                def format_duration_from_xml(duration_str):
                     # ... (funzione durata identica a v8.0) ...
                ...
                for task in all_tasks:
                    # ... (Logica estrazione dati attività identica a v8.0, incluso calcolo slack corretto) ...
                    ...
                    # Logica TUP/TUF (identica a v8.0)
                ...
                # --- CORREZIONE KeyError: Usa .get() per costruire final_milestones_data ---
                ...
                for key in potential_milestones:
                     ...
                     final_milestones_data.append({
                         ...
                         "DataInizioObj": data.get("DataInizioObj") # Può essere None
                     })
                # --- FINE CORREZIONE ---
                ...
                if final_milestones_data:
                    ...
                    # Converti in datetime prima di fillna per evitare errori di tipo misto
                    df_milestones['DataInizioObj'] = pd.to_datetime(df_milestones['DataInizioObj'], errors='coerce').dt.date
                    df_milestones['DataInizioObj'] = df_milestones['DataInizioObj'].fillna(min_date_for_sort) # Gestisci None
