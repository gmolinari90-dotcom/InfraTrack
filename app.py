...
st.set_page_config(page_title="InfraTrack v4.5", page_icon="🚆", layout="wide") # Version updated
...
# --- TITOLO E HEADER ---
st.markdown("## 🚆 InfraTrack v4.5") # Version updated
...
if uploaded_file is not None:
    if not st.session_state.file_processed_success:
        with st.spinner('Caricamento e analisi completa del file in corso...'):
            try:
                # ... (Logica parsing e estrazione dati generali/date progetto/minuti_giorno identica a v4.4) ...
                ...
                def format_duration_from_xml(duration_str):
                     # ... (funzione durata identica a v4.4) ...
                ...
                for task in all_tasks:
                    ...
                    # Logica TUP/TUF (identica a v4.4)
                ...
                # Salvataggio dati TUP/TUF e All Tasks (Identico a v4.4)
                ...
                if final_milestones_data:
                    ...
                    min_date_for_sort = date.min; df_milestones['DataInizioObj'] = df_milestones['DataInizioObj'].fillna(min_date_for_sort)
    ...
    if st.session_state.file_processed_success:
        # --- Sezione 2: Analisi Preliminare (Identica a v4.4) ---
        st.markdown("---")
        ...
        # --- Sezione 3: Analisi Avanzata (Identica a v4.4) ---
